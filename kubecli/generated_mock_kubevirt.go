...
// RemoveInterface mocks base method.
func (m *MockVirtualMachineInterface) RemoveInterface(ctx context.Context, name string, removeInterfaceOptions *v120.RemoveInterfaceOptions) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RemoveInterface", ctx, name, removeInterfaceOptions)
	ret0, _ := ret[0].(error)
	return ret0
}

// RemoveInterface indicates an expected call of RemoveInterface.
func (mr *MockVirtualMachineInterfaceMockRecorder) RemoveInterface(ctx, name, removeInterfaceOptions interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveInterface", reflect.TypeOf((*MockVirtualMachineInterface)(nil).RemoveInterface), ctx, name, removeInterfaceOptions)
}
